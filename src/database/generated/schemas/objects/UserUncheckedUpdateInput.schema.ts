...
import { ExerciseUncheckedUpdateManyWithoutUserNestedInputSchemaObject } from './ExerciseUncheckedUpdateManyWithoutUserNestedInput.schema';
...
export const UserUncheckedUpdateInputSchemaObject = {
  ...
  exercises: Joi.object().keys(ExerciseUncheckedUpdateManyWithoutUserNestedInputSchemaObject),
};
